...
class ModbusRegister(Enum):
    ...
    PWR_CTRL_PATTERN = 3493  # NOT IN RADME YET
    PWR_CH_CTRL = 3494  # NOT IN RADME YET
    PWR_CH_DRV_MONITOR = 3504  # NOT IN RADME YET
    PWR_CH_TARGET = 3495  # NOT IN RADME YET
    PWR_SG_CTRL = 3496  # NOT IN RADME YET
    PWR_SG_TARGET = 3497  # NOT IN RADME YET
    PWR_SG_DRV_MONITOR = 3505  # NOT IN RADME YET
